...
export default async function DashboardPage() {
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      <nav className="sticky top-0 z-20 bg-white border-b border-gray-200 px-6 py-4 flex items-center justify-between">
        <h1 className="text-xl font-bold text-gray-900">Strava Dashboard</h1>
        <div className="flex items-center gap-4">
          <a
            href="https://github.com/arun-gupta/strava-dashboard"
            target="_blank"
